...
# Mantén SameSite=Lax (sirve para navegaciones top-level como volver de Stripe)
SESSION_COOKIE_SAMESITE = "Lax"   # explícito
CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1:8000", "http://localhost:8000"]
SESSION_COOKIE_SECURE = False   # si usas http
